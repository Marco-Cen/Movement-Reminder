 ...
 */
public class CRUD_UpdateDeleteExercisesDatabase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crud_updatedelete_exercisesdatabase);
        ...
        Toast.makeText(CRUD_UpdateDeleteExercisesDatabase.this, "Looking into ID: [" + String.valueOf(id) + "]", Toast.LENGTH_SHORT).show();

        // 'DONT CHANGE' BUTTON
        dontChangebttn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent i = new Intent(CRUD_UpdateDeleteExercisesDatabase.this, CRUD_ViewDatabaseExercises.class);
                startActivity(i);
            }
        });
        ...
        deletebttn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(CRUD_UpdateDeleteExercisesDatabase.this);
                ...
                builder.setPositiveButton("Confirm",new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Toast.makeText(CRUD_UpdateDeleteExercisesDatabase.this, "DELETED From Database: \n \t \t ID: [" + String.valueOf(id) + "] \n \t \t Exercise Name: [" + exerciseName +"] \n \n Hope ya meant to do that!", Toast.LENGTH_LONG).show();
        ...
        updateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(CRUD_UpdateDeleteExercisesDatabase.this, "[" + exerciseName + "] was UPDATED :)", Toast.LENGTH_SHORT).show();
