...
public class PainFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pain_form_activity);
        ...
        viewDbBttn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent i = new Intent(PainFormActivity.this, CRUD_ViewDatabasePainJoints.class);
                startActivity(i);
            }
        });
        ...
        dropdownAdapter = new ArrayAdapter<>(PainFormActivity.this, android.R.layout.simple_spinner_dropdown_item, jointList);
