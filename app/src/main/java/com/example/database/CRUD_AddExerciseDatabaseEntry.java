 ...
 */
public class CRUD_AddExerciseDatabaseEntry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crud_add_exercisedatabase_entry);
        ...
        public void onClick(View v) {
            Intent i = new Intent(CRUD_AddExerciseDatabaseEntry.this, MainActivity.class); //TO BE REPLACED AFTER!
            startActivity(i);
        }
        });
        ...
        viewDbBttn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent i = new Intent(CRUD_AddExerciseDatabaseEntry.this, CRUD_ViewDatabaseExercises.class);
                startActivity(i);
            }
        });
        ...
        submitBttn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(exerciseName)) {
                    ...
                    Toast.makeText(CRUD_AddExerciseDatabaseEntry.this, "Exercise added to the database!", Toast.LENGTH_SHORT).show();
