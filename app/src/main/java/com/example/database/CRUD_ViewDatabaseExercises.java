 ...
 */
public class CRUD_ViewDatabaseExercises extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crud_view_exercisesdatabase);
        ...
        homeBttn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent i = new Intent(CRUD_ViewDatabaseExercises.this, MainActivity.class);
                startActivity(i);
            }
        });
